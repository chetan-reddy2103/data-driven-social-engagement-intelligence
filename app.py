...
@st.cache_data
def load_data():
    content = pd.read_csv("data/content_performance.csv", parse_dates=["date"])
    comments = pd.read_csv("data/comments_analyzed.csv", parse_dates=["created_at"])
    ab = pd.read_csv("data/ab_test_results.csv")
    forecast = pd.read_csv("data/topic_forecast_14d.csv")
